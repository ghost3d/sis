    ...
    for scene in bpy.data.scenes:
        for view_layer in scene.view_layers:
            if bpy.context.scene.view_layers[view_layer.name].use  == True:
                layersRender.append(view_layer.name)
                bpy.context.scene.view_layers[view_layer.name].use = False
    for name in layersRender:
        bpy.context.scene.view_layers[name].use = True
        create_new_file(name,shortname,renderFolder)
        bpy.context.scene.view_layers[name].use = False
    # for scene in bpy.data.scenes:
    #     for view_layer in scene.view_layers:
